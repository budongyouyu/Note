...
\mainmatter
    \input{mainmatter/chapter0.tex}
    \input{mainmatter/chapter1.tex}
    \input{mainmatter/exescrise1.tex}
    \input{mainmatter/chapter2.tex}
    \input{mainmatter/exescrise2.tex}
    \input{mainmatter/chapter3.tex}
    \input{mainmatter/exescrise3.tex}
    \input{mainmatter/chapter4.tex}
    \input{mainmatter/exescrise4.tex}
    \input{mainmatter/chapter5.tex}
    \input{mainmatter/exescrise5.tex}
    \input{mainmatter/chapter6.tex}
    \input{mainmatter/exescrise6.tex}
